...
export function GenerationsFamilies() {
  return (
      ...
      <Container>
        <div className="grid gap-10 sm:grid-cols-2 sm:items-center sm:gap-16">
          <Reveal className="relative aspect-[4/5] overflow-hidden">
            <GenerationsPhotoSlot label="Foto — familia acompañando" tint={ABOUT_COLORS.cream} />
          </Reveal>
          ...
          <Reveal delay={120}>
            ...
            <p className={cn(hind.className, "mt-5 max-w-[48ch] text-lg text-white/70")}>
              Generaciones también sucede en casa. El acompañamiento, la práctica, la oración, la
              puntualidad y el ejemplo de cada familia hacen parte del proceso.
            </p>
            <div className="mt-7">
              <button
                type="button"
