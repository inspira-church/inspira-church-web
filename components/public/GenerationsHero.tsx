  ...
  return (
    <section className="relative flex min-h-[92svh] flex-col justify-end overflow-hidden border-b border-white/10 bg-black pb-12 pt-24 sm:min-h-screen sm:pb-16">
      <div className="absolute inset-0 z-0">
        <GenerationsPhotoSlot label="Foto — niños y jóvenes sirviendo" tint={ABOUT_COLORS.coral} priority />
        <div
      ...
      <Container className="relative z-10">
        ...
        >
          No es una estrategia o un método.{" "}
          <span style={{ color: ABOUT_COLORS.coral }}>Se trata de corazón.</span>
        </p>
        <blockquote
          className={cn(
            hind.className,
